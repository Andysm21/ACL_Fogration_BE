...
function createSubtitle(p1, id) {
    Subtitle.create({
        ...
        Subtitle_Course_ID: (p1.body.Subtitle_Course_ID),
        Subtitle_Video: [],
        Subtitle_Hours: 0
    })
}
...
function createStudentTakeExam(p1, id) {
    StudentTookexam.create({
        StudentTookExam_ID: id, StudentTookExam_Student_ID: p1.body.StudentTookExam_Student_ID,
...
async function createStudentTakeCourse(p1, coursePrice) {
    await StudentTakeCourse.create({
        StudentTakeCourse_CourseID: p1.body.StudentTakeCourse_CourseID,
